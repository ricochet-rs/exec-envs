...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/python-ubuntu/tags?name=2026-09-noble)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/python-ubuntu/manifests/2026-09-noble)

Build the snapshot locally with:

```sh
docker build -t exec-env:python-ubuntu-noble-2026-09 releases/2026-09/python-ubuntu-noble
```
