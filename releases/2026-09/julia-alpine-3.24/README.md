...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/julia-alpine/tags?name=2026-09-3.24)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/julia-alpine/manifests/2026-09-3.24)

Build the snapshot locally with:

```sh
docker build -t exec-env:julia-alpine-3.24-2026-09 releases/2026-09/julia-alpine-3.24
```
