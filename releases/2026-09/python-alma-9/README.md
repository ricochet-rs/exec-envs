...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/python-alma/tags?name=2026-09-9)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/python-alma/manifests/2026-09-9)

Build the snapshot locally with:

```sh
docker build -t exec-env:python-alma-9-2026-09 releases/2026-09/python-alma-9
```
