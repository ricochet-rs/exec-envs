...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/python-alma/tags?name=2026-09-10)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/python-alma/manifests/2026-09-10)

Build the snapshot locally with:

```sh
docker build -t exec-env:python-alma-10-2026-09 releases/2026-09/python-alma-10
```
