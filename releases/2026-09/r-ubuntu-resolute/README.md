...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/r-ubuntu/tags?name=2026-09-resolute)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/r-ubuntu/manifests/2026-09-resolute)

Build the snapshot locally with:

```sh
docker build -t exec-env:r-ubuntu-resolute-2026-09 releases/2026-09/r-ubuntu-resolute
```
