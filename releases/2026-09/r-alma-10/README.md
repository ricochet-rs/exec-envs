...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/r-alma/tags?name=2026-09-10)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/r-alma/manifests/2026-09-10)

Build the snapshot locally with:

```sh
docker build -t exec-env:r-alma-10-2026-09 releases/2026-09/r-alma-10
```
