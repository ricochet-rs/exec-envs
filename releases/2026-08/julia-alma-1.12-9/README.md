...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/julia-alma/tags?name=2026-08-1.12-9)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/julia-alma/manifests/2026-08-1.12-9)

Build the snapshot locally with:

```sh
docker build -t exec-env:julia-alma-1.12-9-2026-08 releases/2026-08/julia-alma-1.12-9
```
