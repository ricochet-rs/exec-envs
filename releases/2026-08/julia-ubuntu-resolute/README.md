...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/julia-ubuntu/tags?name=2026-08-resolute)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/julia-ubuntu/manifests/2026-08-resolute)

Build the snapshot locally with:

```sh
docker build -t exec-env:julia-ubuntu-resolute-2026-08 releases/2026-08/julia-ubuntu-resolute
```
