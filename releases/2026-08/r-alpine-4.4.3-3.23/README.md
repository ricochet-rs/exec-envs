...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/r-alpine/tags?name=2026-08-4.4.3-3.23)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/r-alpine/manifests/2026-08-4.4.3-3.23)

Build the snapshot locally with:

```sh
docker build -t exec-env:r-alpine-4.4.3-3.23-2026-08 releases/2026-08/r-alpine-4.4.3-3.23
```
