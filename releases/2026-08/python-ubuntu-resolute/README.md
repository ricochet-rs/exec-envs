...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/python-ubuntu/tags?name=2026-08-resolute)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/python-ubuntu/manifests/2026-08-resolute)

Build the snapshot locally with:

```sh
docker build -t exec-env:python-ubuntu-resolute-2026-08 releases/2026-08/python-ubuntu-resolute
```
