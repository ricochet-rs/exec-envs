...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/r-alma/tags?name=2026-08-4.4.3-9)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/r-alma/manifests/2026-08-4.4.3-9)

Build the snapshot locally with:

```sh
docker build -t exec-env:r-alma-4.4.3-9-2026-08 releases/2026-08/r-alma-4.4.3-9
```
