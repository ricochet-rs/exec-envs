...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/r-ubuntu/tags?name=2026-08-4.4.3-noble)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/r-ubuntu/manifests/2026-08-4.4.3-noble)

Build the snapshot locally with:

```sh
docker build -t exec-env:r-ubuntu-4.4.3-noble-2026-08 releases/2026-08/r-ubuntu-4.4.3-noble
```
