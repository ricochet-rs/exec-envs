...
- [Docker Hub](https://hub.docker.com/r/ricochetrs/julia-ubuntu/tags?name=2026-08-1.10-noble)
- [Ricochet Registry](https://reg.ricochet.rs/v2/exec-envs/julia-ubuntu/manifests/2026-08-1.10-noble)

Build the snapshot locally with:

```sh
docker build -t exec-env:julia-ubuntu-1.10-noble-2026-08 releases/2026-08/julia-ubuntu-1.10-noble
```
