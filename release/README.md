...
It also generates `deploy/ricochet-previews/values.yaml` for Flux consumers, containing every R, Python, and Julia Resolute environment and the newest R and Julia Alpine environments from the newest archive.
