...
All containerfiles in this repo are configured as follows:

- Rebuilt once per week
- Provided for `amd64` and `arm64`
...
- [ricochetrs/python-alpine](https://hub.docker.com/r/ricochetrs/python-alpine)
